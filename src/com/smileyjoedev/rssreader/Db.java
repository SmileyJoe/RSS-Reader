...
public class Db {
	...
	private static final String CREATE_RSS_ITEM = "CREATE TABLE rss_item (_id integer primary key autoincrement, rss_item_title String not null, rss_item_description String not null, rss_item_ut long not null, rss_item_link String not null, rss_item_content String not null, rss_item_comments_link String not null, rss_item_author String not null, rss_item_read int not null);";
	...
	private static final String CREATE_RSS_ITEM_REL_CATEGORY = "CREATE TABLE rss_item_rel_category (_id integer primary key autoincrement, rss_item_id integer not null, category_id integer not null)";
 	...
 	public static void onCreate(SQLiteDatabase database) {
		...
		values.put("category_title", "All");
		values.put("category_status", Category.STATUS_FAVOURITE);
